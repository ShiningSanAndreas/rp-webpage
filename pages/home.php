...
<body>
        ...
        <div class="mx-auto text-left bg-background max-w-screen-lg p-4 xl:p-0 ">
            ...
            <div class="flex flex-col md:p-4 pb-16">
                ...
                <div class="flex flex-row flex-wrap justify-center md:justify-between pb-12">
                    ...
                    <svg class="md:w-1/2 md:h-1/2 object-cover" viewBox="0 0 440 440" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                        <pattern id="img1" x="0" y="0" width="1" height="1">
                            <image x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMaxYMax slice" href="../assets/image2.png" />
                        </pattern>
                        </defs>
                ...
                <svg viewBox="0 0 200 200" class="md:w-1/2 md:h-1/2 object-cover" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="img2" x="0" y="0" width="1" height="1">
                            <image x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMaxYMax slice" href="../assets/image.png" />
                        </pattern>
                        </defs>
                ...
                <div class="flex flex-row flex-wrap justify-center md:justify-between pb-12">
                    ...
                    <defs>
                        <pattern id="img3" x="0" y="0" width="1" height="1">
                            <image x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMaxYMax slice" href="https://i.imgur.com/wxqSSeL.jpeg" />
                        </pattern>
                        </defs>
    ...
    <div class="max-w-screen-lg mx-auto flex flex-row flex-wrap justify-center md:justify-between py-12">
        <div class="text-tekst md:w-1/3 md:self-center p-2">
            ...
            <a href="https://discord.gg/5vApMEjs9p">
        ...
        <img src="../assets/image.png" alt="First Image" class="w-80 h-80 object-cover">
    </div>
</div>
</body>
