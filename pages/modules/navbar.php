      ...
      <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-primary divide-y divide-gray-100 rounded-lg shadow"
          ...
          <div class="px-4 py-3">
            ...
            <span class="block text-sm text-slate-200 ">Bonnie Green</span>
            <span class="block text-sm  text-slate-200 truncate">name@flowbite.com</span>
          </div>
          <ul class="py-2" aria-labelledby="user-menu-button">
            <li>
              <a href="#" class="block px-4 py-2 text-sm text-slate-200 hover:bg-contrast">Profile</a>
            </li>
            <li>
              <a href="#" class="block px-4 py-2 text-sm text-slate-200 hover:bg-contrast">Settings</a>
            </li>
            <li>
        ...
        <button data-collapse-toggle="navbar-user" type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-slate-200 rounded-lg md:hidden hover:bg-contrast focus:outline-none focus:ring-2 focus:ring-accent"
